...
def generate_details(record_count):
    header_list = [get_first_header, get_second_header, get_third_header, get_fourth_header, get_fifth_header, get_sixth_header, get_seventh_header, get_eighth_header]
    ...
    for x in range(randint(1, 50)):
        random.choice(details_list)(record_count)
    footer_list = [get_first_footer, get_second_footer, get_third_footer]
